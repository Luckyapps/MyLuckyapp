...
var luckyapp_core = {
    ...
    load_error: function(event, message){
        if(event != undefined){
            ...
            document.getElementById("ball_container").innerHTML += "<p style='color:red; font-family: calibri; text-align:center'>Ein Fehler ist aufgetreten: "+ message +"</p><p>"+ JSON.stringify(err) +"</p>"
